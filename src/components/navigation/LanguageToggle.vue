...
const triggerLabel = computed<string>(() => t('accessibility.languageToggle'))
const menuLabel = computed<string>(() => t('accessibility.selectLanguage'))
...
const handleMenuFocusout = (event: FocusEvent): void => {
      ...
      >
        ...
        >
          <button
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-[background-color,color] duration-100 cursor-pointer focus:outline-none focus-visible:bg-zinc-100 dark:focus-visible:bg-zinc-700"
